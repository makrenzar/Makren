  ...
  const SkillIcons = [
    {
      ...
      className:
        "hover:scale-125 ease-in duration-200 cursor-pointer w-10 h-10 lg:w-12 lg:h-12",
    },
    {
      id: "css",
  ...
  return (
    <>
      <div className="mt-20 lg:mt-60 grid grid-flow-cols justify-center items-center gap-y-4">
        ...
        <p className="text-foreground scroll-m-20 text-2xl font-normal tracking-tight bg-white text-black w-64 rotate-3 underline underline-offset-4">
          Frontend Developer
        </p>
      ...
      <div className=" items-center justify-center mt-52 grid grid-cols-4  lg:flex gap-8 lg:gap-24">
        <span className="text-sm lg:text-sm  font-semibold  rounded-sm cursor-pointer">
          Skills
        </span>
        {SkillIcons.map((icon) => (
          <span key={icon.id}>
